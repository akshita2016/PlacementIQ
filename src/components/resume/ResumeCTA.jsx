        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <GradientButton 
              ...
              className="!bg-emerald-600 hover:!bg-emerald-500 hover:shadow-[0_0_20px_rgba(16,185,129,0.4)]"
            >
              Build Your Resume
            </GradientButton>
            <button 
              onClick={() => scrollTo('templates')}
              className="px-8 py-4 bg-white/5 hover:bg-white/10 text-white font-bold rounded-2xl transition-all duration-300 border border-emerald-500/20 flex items-center justify-center gap-2 backdrop-blur-md"
            >
